...
const { updateById, deleteOne } = require("./operations");
...
exports.addProduct = asyncHandler(async (req, res) => {
  ...
  if (product)
    return res.json({ message: "Product Already Exists.", _id: product._id });
...
exports.createProductReview = asyncHandler(async (req, res) => {
  ...
  if (product) {
    ...
    await product.updateOne({ $push: { reviews: review._id } }, { new: true });
